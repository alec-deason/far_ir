...
def main():
    ...
    ctx.o("glass").description("It's an empty glass").noun("glass")
    ctx.o("table").description("It's a table").noun("table").contains("glass")
    ...
    ctx.r("inner_room").description("It's a room").contains("coat_rack").exit("east", "foyer")
